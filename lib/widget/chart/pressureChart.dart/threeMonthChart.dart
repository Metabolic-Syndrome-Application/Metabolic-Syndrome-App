...
class ThreeMonthChart extends StatelessWidget {
  const ThreeMonthChart({super.key});

  @override
  Widget build(BuildContext context) {
    return ThreeMonthChartWidget();
  }
}

class ThreeMonthChartWidget extends StatefulWidget {
  const ThreeMonthChartWidget({super.key});

  @override
  State<ThreeMonthChartWidget> createState() => _ThreeMonthChartWidgetState();
}

class _ThreeMonthChartWidgetState extends State<ThreeMonthChartWidget> {
    ...
    try {
      ...
      setState(() {
        ...
        DateTime startDate = endDate.subtract(Duration(
            days: 90)); // Subtracting 7 days to get the start date (1 week ago)
