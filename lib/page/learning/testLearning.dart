...
import '../../widget/learning/allArticle.dart';

void main() {
  runApp(TestLearning());
}

class TestLearning extends StatelessWidget {
  const TestLearning({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: TestLearningPage(),
    );
  }
}

class TestLearningPage extends StatefulWidget {
  const TestLearningPage({super.key});

  @override
  State<TestLearningPage> createState() => _TestLearningPageState();
}

class _TestLearningPageState extends State<TestLearningPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
              ...
              Expanded(
                child: TabBarView(
                  children: <Widget>[
                    ...
                    Center(
                      child: MedicineArticle(),
                    ),
                    Center(
                      child: BehavierArticle(),
                    ),
                  ],
                ),
              ),
